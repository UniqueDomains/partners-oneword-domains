...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C713%20rows-8250df">
...
> **Important:** this repository is a **public 8,713-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 8,713 rows · **Live catalog:** 5,621,926 domains
...
- `partners.csv` — public CSV extract (8,713 rows)
- `partners.json` — public JSON extract (8,713 rows)
...
| research.partners | premium   | $85.80    | $85.80        | 92             | 41     | 8      | namecheap                                                 |
...
| ----------------------- | ------------------------------------------------ |
| 8,713-row public sample | 5,621,926 live domains                           |
...
> Unique Domains. *Available .PARTNERS One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
